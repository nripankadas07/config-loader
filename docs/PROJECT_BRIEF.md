        ...
        config-loader exists to solve a narrow, inspectable developer-tooling problem:
        Type-safe config loader from env/json/yaml with validation, deep merging, and schema defaults
        ...
        Topics: config, configuration, dotenv, nodejs, typescript, validation, yaml
